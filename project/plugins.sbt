...
sys.env.get("PLAY_VERSION") match {
  ...
  case Some("2.9") => addSbtPlugin("com.typesafe.play" % "sbt-twirl" % "1.6.6")
  case _           => addSbtPlugin("org.playframework.twirl" % "sbt-twirl" % "2.0.4") // 2.0.5 doesn't import TemplateN (to be restored in 2.0.6)
}
